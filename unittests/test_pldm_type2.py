...
def test_SetTID_Response(class_type):
    ...
    assert (class_type.CommandValue == SetTID_Request.CommandValue), "Incorrect command code"
    assert (len(class_type.fields_desc) == 1), "Incorrect number of fields"
...
def test_GetTID_Response(class_type):
    ...
    assert (class_type.CommandValue == GetTID_Request.CommandValue), "Incorrect command code"
...
def test_EventMessageSupported_Response(class_type):
    "Verify xxx_Response initialization"
...
def test_GetPLDMEventLogInfo_Response(class_type):
    ...
    # TODO assert (class_type.MostRecentAddTimestampSeconds)
    assert (class_type.MostRecentAddTimestamp100s == 0)
    assert (class_type.MostRecentEraseTimestampUTCOffset == 0)
    # TODO assert (class_type.MostRecentEraseTimestampSeconds)
