...
"""
Display the default PLDM Type 4 request and response packets.

File : print_dsp0257.py

Brief : Display the default PLDM Type 4 request and response packets.
"""
...
def dump_packets():
    ...
    for cmd in test_pldm4_commands:
        dump_class(cmd)
