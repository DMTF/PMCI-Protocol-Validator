...
# Configuration flags for DSP0222 v1.1.0 Enable Global Multicast Filter Request
NCSI_12H_MDNSV6 = (0 << 0)
NCSI_12H_MDNSV4 = (0 << 1)
NCSI_12H_LLDP = (0 << 2)
NCSI_12H_IPV6_NEIGHBOR_SOLICITATION = (0 << 3)
NCSI_12H_IPV6_MLD = (0 << 4)
NCSI_12H_DHCPV6_MC_FROMSERVER_TO_CLIENTS_LISTENING_ON_WELL_KNOWN_UDP_PORTS = (0 << 5)
NCSI_12H_DHCPV6_RELAY_AND_SERVER_MULTICAST = (0 << 6)
NCSI_12H_IPV6_ROUTER_ADVERTISEMENT = (0 << 7)
NCSI_12H_IPV6_NEIGHBOR_ADVERTISEMENT = (0 << 8)
